...
public class FormValidator 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Cases à éxécuter : ");   //////////////////////////////////
	...
	private static String generateCode(int length)   //***********************************
	{
		 ...
		 if (length > 10) return null;
	        ...
	        char[] charKey =  {'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K',
	        ...
	        {
	        	alphabet += charKey[Math.abs(generator.nextInt(26))]; 
	        }   
	        return alphabet;	         
	}
	...
	private static int[] generateTransform(int nb)    //*********************************
	{
		...
		// compléter   
		for(int i = 0; i<nb; i++) {
			//charTransform[i]=  generator.nextInt(9);
			charTransform[i] = Math.abs(generator.nextInt(10));
		}
